...
/// Get the local mean sidereal time. `time` is used to provide a UTC, and
...
/// Obtain precessed coordinate information. `time` is used to provide a UTC,
...
mod tests {
    ...
    fn test_no_precession_at_j2000() {
        ...
        let eor0 = precess_time(
            ...
            phase_centre,
            j2000_epoch,
            Duration::from_f64(0.0, Unit::Second),
        );
