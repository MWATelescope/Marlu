...
impl UVW {
    ...
    /// Convert an [`XyzGeodetic`] to [`UVW`], given the phase centre. This
    /// function is less convenient than [`UVW::from_xyz`], but may be better in
    /// tight loops as the `sin` and `cos` of the phase centre don't need to be
